...
const FROM = process.env.EMAIL_FROM ?? "BetCRM Support <onboarding@resend.dev>";
        ...
        <tr>
          <td style="padding:32px">
            ...
            <p style="margin:28px 0 0;padding-top:20px;border-top:1px solid #e5e7eb;
              ...
              This message was sent by BetCRM Support. Please quote your reference number
...
function ticketSubmittedHtml(name: string, ticketId: string, issueType: string) {
  return baseHtml(`
    ...
    <p style="margin:0 0 20px;font-size:14px;color:#48484a;line-height:1.7">
      Thank you for contacting BetCRM Support. A member of our team will review your
  ...
  try {
    ...
    switch (type) {
      ...
      case "ticket_resolved":
        ...
        break;
      case "agent_reply":
        subject = `Message from BetCRM Support [${ticketId}]`;
